...
function start() {
  ...
  for (var i = 1; i <= rows; i++) {
    ...
    for (var j = 1; j <= cols; j++) {
      ...
      var img = "static/img/" + images[x] + ".jpeg";
...
function myFunction() {
  ...
  for (var i = 1; i <= (rows * cols) / 2; i++) {
    if (i < 10) {
      ...
      image.src = "static/img/black.jpeg";
  ...
  if (state[str] == 0) {
    ...
    if (flag == 0) {
      ...
      if (
        ...
        var image = "static/img/black.jpeg";
        state[str] = 0;
        state[current_id] = 0;
        setTimeout(function () {
...
/*function countCorona() {
  ...
  fetch(url)
    ...
    .then(function (data) {
      ...
      details.push(data["Global"]);
      details.push(data["Countries"][101]);
      console.log(details);
    })
